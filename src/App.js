...
class Team extends Component {
  constructor(props) {
    ...
    this.sortPlayerName = this.sortPlayerName.bind(this)
  ...
  render() {
    ...
    return (
        <div>
        <div>
            <button onClick={this.sortByPlayer}>
                {this.state.isSorted ? 'Sorted' : "Sort by Players' Names"}
            </button>
        </div>
